...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/') }}">
            <img src="{{ asset('assets/logo/logo.png') }}" width="100%" height="120"/>
            {{--<b>{{ config('app.name', 'PLAN') }}</b>--}}
        </a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
                    ...
                    <div class="col-8">
                        <div class="icheck-primary">
                            ...
                            @if (Route::has('password.request'))
                                <p class="mb-1">
                                    <a href="{{ route('password.request') }}" class="btn btn-sm btn-danger">I forgot my password</a>
                                </p>
                            @endif
                        </div>
                    </div>
