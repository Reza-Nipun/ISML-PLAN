                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('buyer.create') }}" class="btn btn-success">
                                    <i class="fas fa-plus"></i> Create Buyer
                                </a>
                            </h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="" class="table table-bordered table-striped">
                                ...
                                @foreach($buyers as $buyer)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge {{ ($buyer->status == 1 ? 'badge-success' : 'badge-danger') }}">
                                                {{ ($buyer->status == 1 ? 'Active' : 'Inactive') }}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ route('buyer.edit', $buyer->id) }}" class="btn btn-sm btn-primary">
